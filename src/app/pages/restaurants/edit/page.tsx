...
const FormInput = ({ label, placeholder, type = 'text', className = '' }: any) => (
    <div className={className}>
        ...
        <input 
            ...
            className="w-full bg-gray-100/70 border border-gray-200 text-black rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-pink-500" 
        />
    </div>
);
              ...
              <div className="flex items-center gap-6">
                ...
                <main className="p-6 lg:p-8 font-plus">
                    <div className="container mx-auto max-w-4xl font-plus">
                        <h1 className="text-3xl font-bold text-gray-800 mb-8 font-plus">Edit Restaurant</h1>
