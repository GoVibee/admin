...
const DisableModal = ({ onClose }: any) => {
            ...
            >
                ...
                <div className="p-6 space-y-4">
                    <div className="flex justify-between">
                        <span className="font-semibold text-gray-600 items-center">Are you sure you want to disable restaurant</span>
                    </div>
                </div>
    ...
    return (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
            ...
            >
                ...
                <div className="p-6 space-y-4">
                    <div className="flex justify-between">
                        <span className="font-semibold text-gray-600 items-center">Are you sure you want to delete restaurant</span>
                    </div>
                </div>
                <div className="p-6 bg-gray-50 rounded-b-xl flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-3">
                    <button onClick={onClose} className="px-4 cursor-pointer py-2 rounded-lg font-semibold bg-gray-200 text-gray-700 hover:bg-gray-300 transition-colors">
  ...
  return (
    <div className="lg:flex min-h-screen bg-gray-50 w-full font-plus">
                    ...
                    <tr key={venue.id} className="border-b border-gray-200 last:border-b-0 hover:bg-gray-50">
                      ...
                      <td className="p-4">
                        <div className="flex items-center space-x-3 text-sm font-medium text-gray-500">
                          <a  href={`/pages/restaurants/edit`} className="text-purple-600">Edit</a>
                          <span className="text-black mx-1"> | </span>
                        <button onClick={() => setDisable(true)} className="text-red-700 cursor-pointer">
                                <h3>Disable</h3>
                            </button>
                          <span className="text-gray-300">|</span>
                          <a href={`/pages/restaurants/${venue.id}`} className="text-purple-600">View</a>
                          <span className="text-black mx-1"> | </span>
      ...
      <AnimatePresence>
            ...
            <AnimatePresence>
              {disable && (
                  <DisableModal  onClose={() => setDisable(false)} />
              )}
            </AnimatePresence>
    </div>
  );
